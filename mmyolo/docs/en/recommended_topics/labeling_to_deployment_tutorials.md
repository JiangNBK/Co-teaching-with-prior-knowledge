...
```shell
mkdir work_dirs_old
wget https://download.openmmlab.com/mmyolo/v0/yolov5/yolov5_s-v61_syncbn_fast_8xb16-300e_coco/yolov5_s-v61_syncbn_fast_8xb16-300e_coco_20220918_084700-86e02187.pth -P ./work_dirs_old
```
...
python demo/image_demo.py ./data/cat/images \
                          ...
                          ./work_dirs_old/yolov5_s-v61_syncbn_fast_8xb16-300e_coco_20220918_084700-86e02187.pth \
...
# the path of result save, can be omitted, omitted save file name is located under work_dirs_old with the same name of config file.
...
work_dir = './work_dirs_old/yolov5_s-v61_syncbn_fast_1xb32-100e_cat'
...
load_from = './work_dirs_old/yolov5_s-v61_syncbn_fast_8xb16-300e_coco_20220918_084700-86e02187.pth'  # noqa
...
python tools/analysis_tools/dataset_analysis.py configs/custom_dataset/yolov5_s-v61_syncbn_fast_1xb32-100e_cat.py \
                                                --out-dir work_dirs_old/dataset_analysis_cat/train_dataset
```
...
```shell
python tools/analysis_tools/dataset_analysis.py configs/custom_dataset/yolov5_s-v61_syncbn_fast_1xb32-100e_cat.py \
                                                --out-dir work_dirs_old/dataset_analysis_cat/val_dataset \
                                                --val-dataset
```
...
python tools/analysis_tools/optimize_anchors.py configs/custom_dataset/yolov5_s-v61_syncbn_fast_1xb32-100e_cat.py \
                                                ...
                                                --input-shape 640 640 \
                                                --prior-match-thr 4.0 \
                                                --out-dir work_dirs_old/dataset_analysis_cat
```
...
```shell
tensorboard --logdir=work_dirs_old/yolov5_s-v61_syncbn_fast_1xb32-100e_cat
```
...
```python
_base_ = '../yolov6/yolov6_s_gt1024.py'
...
# the path of result save, can be omitted, omitted save file name is located under work_dirs_old with the same name of config file.
# If a config variable changes only part of its parameters, changing this variable will save the new training file elsewhere
work_dir = './work_dirs_old/yolov6_s_syncbn_fast_1xb32-100e_cat'

# load_from can specify a local path or URL, setting the URL will automatically download, because the above has been downloaded, we set the local path here
# since this tutorial is fine-tuning on the cat dataset, we need to use `load_from` to load the pre-trained model from MMYOLO. This allows for faster convergence and accuracy
load_from = './work_dirs_old/yolov6_s_syncbn_fast_8xb32-400e_coco_20221102_203035-932e1d91.pth'  # noqa
...
```bash
wget https://download.openmmlab.com/mmyolo/v0/yolov6/yolov6_s_syncbn_fast_8xb32-400e_coco/yolov6_s_syncbn_fast_8xb32-400e_coco_20221102_203035-932e1d91.pth -P work_dirs_old/
```
...
python demo/image_demo.py ./data/cat/images \
                          ...
                          ./work_dirs_old/yolov6_s_syncbn_fast_1xb32-100e_cat/best_coco/bbox_mAP_epoch_96.pth \
...
python ./tools/deploy.py \
    ...
    ${MMYOLO_PATH}/work_dirs_old/yolov6_s_syncbn_fast_1xb32-100e_cat/best_coco/bbox_mAP_epoch_96.pth \
...
python deploy_demo.py \
    ...
    --out-dir ${MMYOLO_PATH}/work_dirs_old/deploy_predict_out \
    --device cuda:0 \
    --score-thr 0.5
```
