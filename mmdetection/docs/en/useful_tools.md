...
demo/demo.jpg \
configs/yolo/FAIR1M_yolov3.py \
checkpoint/FAIR1M_yolov3-421362b6.pth \
yolov3
```
...
```shell
python tools/analysis_tools/optimize_anchors.py configs/yolo/FAIR1M_yolov3.py --algorithm differential_evolution --input-shape 608 608 --device cuda --output-dir work_dirs
```
