...
GPUS=8  GPUS_PER_NODE=8  CPUS_PER_TASK=2 ./tools/slurm_train.sh openmmlab FAIR1M_yolov3 configs/yolo/FAIR1M_yolov3.py ./tools/work_dir/FAIR1M_yolov3 --cfg-options checkpoint_config.max_keep_ckpts=1 >/dev/null &
