...
echo 'configs/yolo/FAIR1M_yolov3.py' &
GPUS=8  GPUS_PER_NODE=8  CPUS_PER_TASK=2 tools/slurm_test.sh $PARTITION FAIR1M_yolov3 configs/yolo/FAIR1M_yolov3.py $CHECKPOINT_DIR/FAIR1M_yolov3-421362b6.pth --work-dir tools/batch_test/FAIR1M_yolov3 --eval bbox --cfg-option dist_params.port=29719  &
